        ...
        <section className="flex-1 flex flex-col md:flex-row items-center container mx-auto px-6 overflow-hidden">
          ...
          <div className="w-full md:w-1/2 h-full flex items-center justify-center relative p-8">
            ...
            <div className="relative z-10 w-full h-full flex items-center justify-center overflow-hidden">
              <video autoPlay muted loop playsInline className="max-h-[85%] max-w-full object-contain rounded-[48px] shadow-[0_0_100px_rgba(37,99,235,0.15)] border border-white/5"><source src="/hero-video.mp4" type="video/mp4" /></video>
            </div>
          </div>
        </section>
      </section>
